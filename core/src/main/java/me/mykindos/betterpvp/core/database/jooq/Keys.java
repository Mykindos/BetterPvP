...
public class Keys {
    ...
    public static final UniqueKey<GrafanaConfigRecord> GRAFANA_CONFIG_PKEY = Internal.createUniqueKey(GrafanaConfig.GRAFANA_CONFIG, DSL.name("grafana_config_pkey"), new TableField[] { GrafanaConfig.GRAFANA_CONFIG.REALM, GrafanaConfig.GRAFANA_CONFIG.PLUGIN, GrafanaConfig.GRAFANA_CONFIG.CONFIG_FILE, GrafanaConfig.GRAFANA_CONFIG.CONFIG_KEY }, true);
