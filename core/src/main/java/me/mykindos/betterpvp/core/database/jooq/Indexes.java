...
public class Indexes {
    ...
    public static final Index IDX_ACHIEVEMENT_COMPLETIONS_TOTAL = Internal.createIndex(DSL.name("idx_achievement_completions_total"), AchievementCompletions.ACHIEVEMENT_COMPLETIONS, new OrderField[] { AchievementCompletions.ACHIEVEMENT_COMPLETIONS.PERIOD, AchievementCompletions.ACHIEVEMENT_COMPLETIONS.NAMESPACE, AchievementCompletions.ACHIEVEMENT_COMPLETIONS.KEYNAME }, false);
