...
abstract class ItemUpdateEvent {
    ...
    private final me.mykindos.betterpvp.core.inventory.inventory.event.UpdateReason updateReason;
     ...
     * @param updateReason The {@link me.mykindos.betterpvp.core.inventory.inventory.event.UpdateReason} for the calling of this event.
     ...
     */
    public ItemUpdateEvent(@NotNull Inventory inventory, int slot, @Nullable me.mykindos.betterpvp.core.inventory.inventory.event.UpdateReason updateReason,
    ...
    /**
     * Gets the {@link me.mykindos.betterpvp.core.inventory.inventory.event.UpdateReason} for the calling of this event.
     *
