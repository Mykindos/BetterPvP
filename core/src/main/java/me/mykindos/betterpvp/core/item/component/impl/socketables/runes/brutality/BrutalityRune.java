...
public class BrutalityRune implements Socketable, Reloadable {
    ...
    public @NotNull Component getDisplayName() {
        return Translations.component("core.item.rune.brutality.name");
    }
    ...
    public @NotNull List<Component> getDescriptionLines() {
        return Arrays.asList(Translations.componentLines("core.item.rune.brutality.lore",
                RuneLore.damage(String.format("%.1f", damageIncrease))));
    }
