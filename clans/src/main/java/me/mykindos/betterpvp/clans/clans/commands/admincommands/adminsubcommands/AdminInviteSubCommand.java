...
@Singleton
@SubCommand(ClanAdminCommand.class)
public class AdminInviteSubCommand extends ClanAdminSubCommand {
    ...
    @Inject
    public AdminInviteSubCommand(ClanManager clanManager, GamerManager gamerManager) {
