...
public class Thorns extends Skill implements PassiveSkill, Listener {
    ...
    private final Map<LivingEntity, Queue<Long>> hitTimestamps = new WeakHashMap<>();
    ...
    @UpdateEvent
    public void checkThornsPlayer() {
        long currentTime = System.currentTimeMillis();
        long expirationTime = (long)(reflectTime * 1000);

        for (Map.Entry<LivingEntity, Queue<Long>> entry : hitTimestamps.entrySet()) {
