...
public interface TabGui extends me.mykindos.betterpvp.core.inventory.gui.Gui {
    ...
    static @NotNull Builder normal() {
        return new me.mykindos.betterpvp.core.inventory.gui.TabGuiImpl.BuilderImpl();
    }
     ...
     * @param tabs             The {@link me.mykindos.betterpvp.core.inventory.gui.Gui Guis} to use as tabs.
     * @param contentListSlots The slots where content should be displayed.
     * @return The created {@link TabGui}.
     */
    static @NotNull TabGui of(int width, int height, @NotNull List<Gui> tabs, int... contentListSlots) {
        return new me.mykindos.betterpvp.core.inventory.gui.TabGuiImpl(width, height, tabs, contentListSlots);
    }
     ...
     * @return The created {@link TabGui}.
     */
    static @NotNull TabGui of(Structure structure, @NotNull List<Gui> tabs) {
        return new me.mykindos.betterpvp.core.inventory.gui.TabGuiImpl(tabs, structure);
    }
     ...
     */
    interface Builder extends me.mykindos.betterpvp.core.inventory.gui.Gui.Builder<TabGui, Builder> {
         ...
         */
        @Contract("_ -> this")
        @NotNull Builder setTabs(@NotNull List<Gui> tabs);
