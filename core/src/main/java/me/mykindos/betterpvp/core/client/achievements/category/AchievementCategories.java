...
public class AchievementCategories {
    ...
    public static NamespacedKey DUNGEONS = new NamespacedKey("dungeons", "dungeons_category");
    public static NamespacedKey DUNGEONS_BRAEWOOD_CAVERNS_PERIOD = new NamespacedKey("dungeons", "braewood_caverns_period");
