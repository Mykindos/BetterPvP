package me.mykindos.betterpvp.core.item.component.impl.socketables.runes.flameguard;
...
@Singleton
@EqualsAndHashCode
public class FlameguardRune implements Socketable, Reloadable {
    ...
    public @NotNull Component getDisplayName() {
        return Translations.component("core.item.rune.flameguard.name");
    }

    @Override
    public @NotNull List<Component> getDescriptionLines() {
        return Arrays.asList(Translations.componentLines("core.item.rune.flameguard.lore",
                RuneLore.health(UtilFormat.formatNumber(getMitigation() * 100) + "%")));
    }
