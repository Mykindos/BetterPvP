 ...
 * @see me.mykindos.betterpvp.core.inventory.gui.PagedInventoriesGuiImpl
 */
final class PagedItemsGuiImpl extends AbstractPagedGui<Item> {
    ...
    public void bake() {
        ...
        List<List<me.mykindos.betterpvp.core.inventory.gui.SlotElement>> pages = new ArrayList<>();
        List<me.mykindos.betterpvp.core.inventory.gui.SlotElement> page = new ArrayList<>(contentSize);
