 ...
 */
@Singleton
public class NeutralableClanArgument extends ClanArgument {
    @Inject
    protected NeutralableClanArgument(ClanManager clanManager) {
        super(clanManager);
    }

    @Override
    public String getName() {
        return "Neutralable Clan";
    }
    ...
    protected void executorClanChecker(@Nullable Player executor, @NotNull Clan target) throws CommandSyntaxException {
        ...
        clanManager.canNeutralThrow(executorClan, target);
    }
}
