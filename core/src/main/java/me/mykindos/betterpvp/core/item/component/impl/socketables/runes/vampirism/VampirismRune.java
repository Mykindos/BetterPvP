...
@Singleton
@EqualsAndHashCode
public class VampirismRune implements Socketable, Reloadable {
    ...
    public @NotNull Component getDisplayName() {
        return Translations.component("core.item.rune.vampirism.name");
    }
    ...
    public @NotNull List<Component> getDescriptionLines() {
        return Arrays.asList(Translations.componentLines("core.item.rune.vampirism.lore",
                RuneLore.health(UtilFormat.formatNumber(getHealing()))));
    }
