...
public class AlligatorsTooth extends WeaponItem implements Reloadable {
    ...
    private AlligatorsTooth(Champions champions,
        ...
        addSerializableComponent(new TemperComponent(TemperProfile.slow()));
    }
    ...
    public void reload() {
        ...
        gatorStrokeAbility.setSkimmingDrainMultiplier(config.getConfig("skimmingDrainMultiplier", 3.0, Double.class));
