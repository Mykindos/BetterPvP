 ...
 * Instead, use the static factory or builder functions from the {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui} interface,
 * such as {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui#items()}, {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui#guis()} or {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui#inventories()}
 * to create a new {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui}.
 *
...
public abstract class AbstractScrollGui<C> extends me.mykindos.betterpvp.core.inventory.gui.AbstractGui implements me.mykindos.betterpvp.core.inventory.gui.ScrollGui<C> {
    ...
    /**
     * The baked {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements}, containing the content.
     */
    protected List<me.mykindos.betterpvp.core.inventory.gui.SlotElement> elements;
     ...
     * Otherwise, use the static builder functions from {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui}, such as
     * {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui#items()}, {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui#guis()} or {@link me.mykindos.betterpvp.core.inventory.gui.ScrollGui#inventories()} to obtain a builder instance.
     *
     * @param <C> The content type.
     */
    public abstract static class AbstractBuilder<C>
        extends AbstractGui.AbstractBuilder<me.mykindos.betterpvp.core.inventory.gui.ScrollGui<C>, me.mykindos.betterpvp.core.inventory.gui.ScrollGui.Builder<C>>
        implements me.mykindos.betterpvp.core.inventory.gui.ScrollGui.Builder<C>
    {
        ...
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.ScrollGui.@NotNull Builder<C> setContent(@NotNull List<@NotNull C> content) {
            this.content = content;
            return this;
        }
        
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.ScrollGui.@NotNull Builder<C> addContent(@NotNull C content) {
        ...
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.ScrollGui.@NotNull Builder<C> setScrollHandlers(@NotNull List<@NotNull BiConsumer<Integer, Integer>> handlers) {
            scrollHandlers = handlers;
            return this;
        }
        
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.ScrollGui.@NotNull Builder<C> addScrollHandler(@NotNull BiConsumer<Integer, Integer> handler) {
            if (scrollHandlers == null)
        ...
        @Override
        protected void applyModifiers(@NotNull me.mykindos.betterpvp.core.inventory.gui.ScrollGui<C> gui) {
