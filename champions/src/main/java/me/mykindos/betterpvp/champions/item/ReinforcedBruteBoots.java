...
public class ReinforcedBruteBoots extends ArmorItem {
    ...
    private ReinforcedBruteBoots(Champions champions) {
        super(champions, translatableName("champions.item.reinforced-brute-boots.name"), Item.builder(Material.DIAMOND_BOOTS)
    ...
    private void registerRecipe(CraftingRecipeRegistry registry, ItemFactory itemFactory) {
        ...
        registered = true;
        final BaseItem ingot = itemFactory.getFallbackItem(Material.DIAMOND);
        final BaseItem block = itemFactory.getFallbackItem(Material.DIAMOND_BLOCK);
        ...
        registry.registerRecipe(new NamespacedKey("champions", "reinforced_brute_boots_top"), builder1.build());
        ...
        registry.registerRecipe(new NamespacedKey("champions", "reinforced_brute_boots_bottom"), builder2.build());
    }
}
