 ...
 * Instead, use the static builder or factory functions from the {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui} interface,
 * such as {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui#items()}, {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui#guis()} or, {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui#inventories()}
 * to create a new {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui}.
 *
 * @param <C> The content type.
 * @see me.mykindos.betterpvp.core.inventory.gui.PagedItemsGuiImpl
 * @see me.mykindos.betterpvp.core.inventory.gui.PagedNestedGuiImpl
 */
public abstract class AbstractPagedGui<C> extends me.mykindos.betterpvp.core.inventory.gui.AbstractGui implements me.mykindos.betterpvp.core.inventory.gui.PagedGui<C> {
     ...
     */
    protected List<List<me.mykindos.betterpvp.core.inventory.gui.SlotElement>> pages;
     ...
     * Otherwise, use the static builder functions from {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui}, such as
     * {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui#items()}, {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui#guis()} or {@link me.mykindos.betterpvp.core.inventory.gui.PagedGui#inventories()} to obtain a builder instance.
     *
     * @param <C> The content type.
     */
    public static abstract class AbstractBuilder<C>
        extends AbstractGui.AbstractBuilder<me.mykindos.betterpvp.core.inventory.gui.PagedGui<C>, me.mykindos.betterpvp.core.inventory.gui.PagedGui.Builder<C>>
        implements me.mykindos.betterpvp.core.inventory.gui.PagedGui.Builder<C>
    {
        ...
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.PagedGui.@NotNull Builder<C> setContent(@NotNull List<@NotNull C> content) {
            this.content = content;
            return this;
        }
        
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.PagedGui.@NotNull Builder<C> addContent(@NotNull C content) {
        ...
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.PagedGui.@NotNull Builder<C> setPageChangeHandlers(@NotNull List<@NotNull BiConsumer<Integer, Integer>> handlers) {
            pageChangeHandlers = handlers;
            return this;
        }
        
        @Override
        public me.mykindos.betterpvp.core.inventory.gui.PagedGui.@NotNull Builder<C> addPageChangeHandler(@NotNull BiConsumer<Integer, Integer> handler) {
            if (pageChangeHandlers == null)
        ...
        @Override
        protected void applyModifiers(@NotNull me.mykindos.betterpvp.core.inventory.gui.PagedGui<C> gui) {
