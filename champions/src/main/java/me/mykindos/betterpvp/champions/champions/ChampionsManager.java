...
public class ChampionsManager {
    ...
    @Inject
    public ChampionsManager(ClientManager clientManager, final DisplayNameProvider displayNameProvider, ChampionsSkillManager skills, RoleManager roles, BuildManager builds,
