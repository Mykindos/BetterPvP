...
public enum TipOld {
    ...
    TipOld(int weightCategory, int weight, Component component, int id) {
    ...
    TipOld(int weightCategory, int weight, String preCommand, String command, int id) {
        this.weightCategory = weightCategory;
        this.weight = weight;
    ...
    TipOld(int weightCategory, int weight, String preCommand, String command, String suggestCommand, String hoverText, int id) {
        this.weightCategory = weightCategory;
        this.weight = weight;
