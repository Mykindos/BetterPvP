...
public class Indexes {
    ...
    public static final Index IDX_GRAFANA_CONFIG_PLUGIN_FILE = Internal.createIndex(DSL.name("idx_grafana_config_plugin_file"), GrafanaConfig.GRAFANA_CONFIG, new OrderField[] { GrafanaConfig.GRAFANA_CONFIG.PLUGIN, GrafanaConfig.GRAFANA_CONFIG.CONFIG_FILE }, false);
