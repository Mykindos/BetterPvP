package me.mykindos.betterpvp.progression.profession.skill.woodcutting.treefeller;
...
@Singleton
@SkillId("tree_feller")
public class TreeFellerSkill extends ProfessionSkill implements CooldownProfessionSkill {
    ...
    public void loadSkillConfig() {
        ...
        cooldownDecreasePerLevel = getSkillConfig("cooldownDecreasePerLevel", 1.0, Double.class);
        maxBlocksThatCanBeFelled = getSkillConfig("maxBlocksThatCanBeFelled", 15, Integer.class);
    }
