package me.mykindos.betterpvp.core.item.component.impl.socketables.runes.scorching;
...
@Singleton
@EqualsAndHashCode
public class ScorchingRune implements Socketable, Reloadable {
    ...
    public @NotNull Component getDisplayName() {
        return Translations.component("core.item.rune.scorching.name");
    }
    ...
    public @NotNull List<Component> getDescriptionLines() {
        return Arrays.asList(Translations.componentLines("core.item.rune.scorching.lore",
                RuneLore.val(UtilFormat.formatNumber(getChance() * 100) + "%"),
                RuneLore.time(UtilFormat.formatNumber(getDuration()) + "s")));
    }
