package me.mykindos.betterpvp.core.item.component.impl.socketables.runes.ferocity;
...
@Singleton
@EqualsAndHashCode
public class FerocityRune implements Socketable, Reloadable {
    ...
    public @NotNull Component getDisplayName() {
        return Translations.component("core.item.rune.ferocity.name");
    }

    @Override
    public @NotNull List<Component> getDescriptionLines() {
        return Arrays.asList(Translations.componentLines("core.item.rune.ferocity.lore",
                RuneLore.val(UtilFormat.formatNumber(delay * 100) + "%")));
    }
