...
@Singleton
@ItemKey("champions:reinforced_mage_boots")
public class ReinforcedMageBoots extends ArmorItem {

    private transient boolean registered;

    @Inject
    private ReinforcedMageBoots(Champions champions) {
        super(champions, translatableName("champions.item.reinforced-mage-boots.name"), Item.builder(Material.GOLDEN_BOOTS)
    ...
    private void registerRecipe(CraftingRecipeRegistry registry, ItemFactory itemFactory) {
        ...
        registry.registerRecipe(new NamespacedKey("champions", "reinforced_mage_boots_top"), builder1.build());
        ...
        registry.registerRecipe(new NamespacedKey("champions", "reinforced_mage_boots_bottom"), builder2.build());
    }
}
