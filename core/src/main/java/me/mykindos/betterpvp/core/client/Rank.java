...
public enum Rank {
    ...
    YOUTUBE("YT",
            ...
            List.of("A BetterPvP Content Creator"),
            1
    ),
    HELPER("Helper",
    ...
    TRIAL_MOD("Trial Mod",
            ...
            List.of("A BetterPvP Trial Moderator",
                    "This person is trialing to",
                    "Be a BetterPvP Moderator. You can",
                    "Ask them for help!"),
            3
    ),
    MODERATOR("Mod",
    ...
    MINEPLEX("Mineplex",
            ...
            UtilMessage.MineplexPrefix,
            List.of("A Mineplex Staff Member",
