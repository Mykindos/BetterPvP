...
public class InventoryPickupItemLogFormatter implements ILogFormatter {
    ...
    public Component formatLog(HashMap<String, String> context) {
        return Component.empty().append(Component.text(context.get(LogContext.ITEM_NAME), NamedTextColor.GREEN)
                ...
                .append(Component.text(" was picked up by block ", NamedTextColor.GRAY))
    ...
    public Description getDescription(CachedLog cachedLog, LogRepository logRepository, Windowed previous) {
        ...
        List<Component> lore = List.of(
                ...
                Component.text("was picked up by block ", NamedTextColor.GRAY)
        ...
        ItemProvider itemProvider = ItemView.builder()
                .displayName(Component.text("Inventory Pickup Item"))
                .material(material)
                .lore(lore)
                .build();
