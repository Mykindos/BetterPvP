 ...
 */
public abstract class AbstractTabGui extends me.mykindos.betterpvp.core.inventory.gui.AbstractGui implements TabGui {
    ...
    private void updateContent() {
        List<me.mykindos.betterpvp.core.inventory.gui.SlotElement> slotElements = getSlotElements(currentTab);
