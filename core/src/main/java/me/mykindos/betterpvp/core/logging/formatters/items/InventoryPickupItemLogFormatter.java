...
@WithReflection
public class InventoryPickupItemLogFormatter implements ILogFormatter {

    @Override
    public String getAction() {
        return "ITEM_INVENTORY_PICKUP";
    }

    @Override
    public Component formatLog(HashMap<String, String> context) {
        return Translations.component("core.log.inventory-pickup-item.1",
    ...
    public Description getDescription(CachedLog cachedLog, LogRepository logRepository, Windowed previous) {
        ...
        List<Component> lore = List.of(
                ...
                Translations.component("core.log.inventory-pickup-item.2",
                ...
                Translations.component("core.log.inventory-pickup-item.3",
        ...
        ItemProvider itemProvider = ItemView.builder()
                .displayName(Translations.component("core.log.inventory-pickup-item.4"))
                .material(material)
                .lore(lore)
                .build();
