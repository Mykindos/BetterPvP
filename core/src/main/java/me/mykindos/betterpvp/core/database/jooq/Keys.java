...
public class Keys {
    ...
    public static final UniqueKey<PeriodMetaRecord> PERIOD_META_PKEY = Internal.createUniqueKey(PeriodMeta.PERIOD_META, DSL.name("period_meta_pkey"), new TableField[] { PeriodMeta.PERIOD_META.ID }, true);
