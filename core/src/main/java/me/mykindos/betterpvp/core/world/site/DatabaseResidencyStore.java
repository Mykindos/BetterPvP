...
/**
 * Keeps residency in the {@code site_residency} table, one row per player per {@link Kind}.
 * <p>
...
@CustomLog
@Singleton
public class DatabaseResidencyStore implements ResidencyStore {
    ...
    @Inject
    public DatabaseResidencyStore(@NotNull Database database) {
