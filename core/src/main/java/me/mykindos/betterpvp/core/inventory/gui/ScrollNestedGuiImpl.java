...
import me.mykindos.betterpvp.core.inventory.gui.ScrollInventoryGuiImpl;
...
final class ScrollNestedGuiImpl extends AbstractScrollGui<Gui> {
    ...
    @Override
    public void bake() {
        ArrayList<me.mykindos.betterpvp.core.inventory.gui.SlotElement> elements = new ArrayList<>();
        for (Gui gui : content) {
