...
public class ContainerStoreItemLogFormatter implements ILogFormatter {
    ...
    public Component formatLog(HashMap<String, String> context) {
        return Translations.component("core.log.container-store-item.1",
    ...
    public Description getDescription(CachedLog cachedLog, LogRepository logRepository, Windowed previous) {
        ...
        List<Component> lore = List.of(
                ...
                UtilMessage.DIVIDER,
                Component.text(context.get(LogContext.CLIENT_NAME), NamedTextColor.YELLOW)
                        .append(Translations.component("core.log.container-store-item.2").color(NamedTextColor.GRAY)),
                Component.text(context.get(LogContext.ITEM_NAME), NamedTextColor.GREEN),
                Component.text("(", NamedTextColor.LIGHT_PURPLE)
                        .append(Component.text(context.get(LogContext.ITEM)))
                        .append(Component.text(")")),
                Translations.component("core.log.container-store-item.3").color(NamedTextColor.GRAY)
                        .append(Component.text(" "))
                        .append(Component.text(context.get(LogContext.BLOCK) == null ? "NULL" : context.get(LogContext.BLOCK), NamedTextColor.GREEN)),
                Translations.component("core.log.container-store-item.4",
        ...
        ItemProvider itemProvider = ItemView.builder()
                .displayName(Translations.component("core.log.container-store-item.5"))
                .material(material)
                .lore(lore)
                .glow(true)
                .build();
