...
public class Keys {
    ...
    public static final UniqueKey<GrafanaRoleMatchupSnapshotRecord> GRAFANA_ROLE_MATCHUP_SNAPSHOT_PKEY = Internal.createUniqueKey(GrafanaRoleMatchupSnapshot.GRAFANA_ROLE_MATCHUP_SNAPSHOT, DSL.name("grafana_role_matchup_snapshot_pkey"), new TableField[] { GrafanaRoleMatchupSnapshot.GRAFANA_ROLE_MATCHUP_SNAPSHOT.ID }, true);
