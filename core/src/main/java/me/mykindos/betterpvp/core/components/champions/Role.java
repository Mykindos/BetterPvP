...
public enum Role {
    ...
    GLADIATOR("Gladiator", TextColor.color(112, 255, 241), Material.DIAMOND_HELMET, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_LEGGINGS, Material.DIAMOND_BOOTS),
    ...
    PALADIN("Paladin", TextColor.color(255, 237, 69), Material.GOLDEN_HELMET, Material.GOLDEN_CHESTPLATE, Material.GOLDEN_LEGGINGS, Material.GOLDEN_BOOTS),
