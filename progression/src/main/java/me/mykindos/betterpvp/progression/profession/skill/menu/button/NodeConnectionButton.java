...
public class NodeConnectionButton extends ControlItem<ProfessionMenu> {

    private final ConnectionType connectionType;
    private final List<ProfessionNode> targetSkills;
    private final ProfessionData professionData;

    public NodeConnectionButton(ConnectionType connectionType, List<ProfessionNode> targetSkills, ProfessionData professionData) {
    ...
    public NodeConnectionButton(ConnectionType connectionType, ProfessionNode targetSkill, ProfessionData professionData) {
        this.connectionType = connectionType;
    ...
    public ItemProvider getItemProvider(ProfessionMenu professionMenu) {
        ...
        ItemView.ItemViewBuilder itemViewBuilder = ItemView.builder()
                ...
                .itemModel(new NamespacedKey("minecraft", "l_skilltree_path" + (allSkillsActive ?
                        connectionType.getActiveModelData(getGui().getNodeSlotType()) :
