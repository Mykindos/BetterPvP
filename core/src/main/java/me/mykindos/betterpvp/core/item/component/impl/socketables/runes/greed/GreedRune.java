package me.mykindos.betterpvp.core.item.component.impl.socketables.runes.greed;
...
@Singleton
@EqualsAndHashCode
public class GreedRune implements Socketable, Reloadable {
    ...
    public @NotNull Component getDisplayName() {
        return Translations.component("core.item.rune.greed.name");
    }

    @Override
    public @NotNull List<Component> getDescriptionLines() {
        return Arrays.asList(Translations.componentLines("core.item.rune.greed.lore",
                RuneLore.coins(UtilFormat.formatNumber(percentageBonus * 100) + "%")));
    }
