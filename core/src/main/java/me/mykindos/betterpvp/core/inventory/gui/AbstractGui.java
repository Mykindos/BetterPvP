...
import me.mykindos.betterpvp.core.inventory.inventory.ObscuredInventory;
...
import me.mykindos.betterpvp.core.inventory.window.AbstractDoubleWindow;
import me.mykindos.betterpvp.core.inventory.window.AbstractSingleWindow;
import me.mykindos.betterpvp.core.inventory.window.AbstractSplitWindow;
...
public abstract class AbstractGui implements Gui, GuiParent {
    ...
    private final me.mykindos.betterpvp.core.inventory.gui.SlotElement[] slotElements;
    ...
    private me.mykindos.betterpvp.core.inventory.gui.SlotElement[] animationElements;
    ...
    protected AbstractGui(int width, int height) {
        ...
        slotElements = new me.mykindos.betterpvp.core.inventory.gui.SlotElement[size];
    }
    ...
    /**
     * Handles a click on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param element The {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement} that was clicked
     * @param event   The {@link InventoryClickEvent} that was triggered
     */
    protected void handleInvSlotElementClick(me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement element, InventoryClickEvent event) {
    ...
    /**
     * Handles a left click on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param event     The {@link InventoryClickEvent} that was triggered
    ...
    /**
     * Handles a right click on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param event     The {@link InventoryClickEvent} that was triggered
     * @param inventory The {@link Inventory} that was clicked
     * @param slot      The slot that was clicked
    ...
    /**
     * Handles a shift click on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param event     The {@link InventoryClickEvent} that was triggered
     * @param inventory The {@link Inventory} that was clicked
     * @param slot      The slot that was clicked
    ...
    /**
     * Handles a number key press on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param event     The {@link InventoryClickEvent} that was triggered
     * @param inventory The {@link Inventory} that was clicked
     * @param slot      The slot that was clicked
    ...
    /**
     * Handles an off-hand key press on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param event     The {@link InventoryClickEvent} that was triggered
     * @param inventory The {@link Inventory} that was clicked
     * @param slot      The slot that was clicked
    ...
    /**
     * Handles dropping items from a slot in an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
    ...
    /**
     * Handles a double click on an {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement.InventorySlotElement}.
     *
     * @param event  The {@link InventoryClickEvent} that was triggered
     * @param player The {@link Player} that clicked
     * @param cursor The {@link ItemStack} that is on the cursor
    ...
    @Override
    public void playAnimation(@NotNull Animation animation, @Nullable Predicate<me.mykindos.betterpvp.core.inventory.gui.SlotElement> filter) {
        ...
        for (int i = 0; i < size; i++) {
            me.mykindos.betterpvp.core.inventory.gui.SlotElement element = getSlotElement(i);
    ...
    @Override
    @Nullable
    public me.mykindos.betterpvp.core.inventory.gui.SlotElement @NotNull [] getSlotElements() {
    ...
    @Override
    public void setSlotElement(int x, int y, me.mykindos.betterpvp.core.inventory.gui.SlotElement slotElement) {
    ...
    public abstract static class AbstractBuilder<G extends Gui, S extends Builder<G, S>> implements Builder<G, S> {
        ...
        @Override
        public @NotNull S addIngredient(char key, @NotNull me.mykindos.betterpvp.core.inventory.gui.SlotElement element) {
