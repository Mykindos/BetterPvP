package me.mykindos.betterpvp.progression.leaderboards;
...
@Singleton
@CustomLog
public class ProgressionLeaderboardLoader extends LeaderboardLoader {

    @Inject
    public ProgressionLeaderboardLoader(LeaderboardManager leaderboardManager, Progression plugin) {
