...
public class DominationTeamMapStatMenu extends AbstractStatPagedMenu {
     ...
     * @param period
     */
    public DominationTeamMapStatMenu(@NotNull Client client, @Nullable Windowed previous, StatFilterType type, Period period, RealmManager realmManager, String teamName) {
