...
public enum Role {
    ...
    RANGER("Ranger", 36, "Ranger is a ranged class skilled in the use of the bow. There are different options, rewarding precision, patience, or long distance accuracy.",
