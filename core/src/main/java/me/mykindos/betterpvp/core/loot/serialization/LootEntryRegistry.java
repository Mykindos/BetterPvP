 ...
 * <p>
 * Core registers built-in types ("dropped_item", "given_item", "dropped_coin", "given_coin")
 * automatically in the static initialiser. Other modules should register their custom types
 * in {@code onLoad()} to guarantee they are present before loot tables are loaded during
 * Core's {@code onEnable()}.
 * <p>
...
public final class LootEntryRegistry {
     ...
     *
     * @param type   The type string as it appears in the JSON (e.g. {@code "given_clan_energy"}).
