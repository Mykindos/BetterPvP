...
/**
 * A {@link me.mykindos.betterpvp.core.inventory.inventory.Inventory} which is backed by a bukkit {@link Inventory}.
 * <p>
 * Changes in this inventory are applied in the referenced inventory and changes in the bukkit inventory are visible
 * in this inventory.
 * <p>
 * Changes done using the methods provided by {@link me.mykindos.betterpvp.core.inventory.inventory.Inventory} will cause displaying
 * {@link Window Windows} to be {@link me.mykindos.betterpvp.core.inventory.inventory.Inventory#notifyWindows() notified}, but changes
 * done directly in the bukkit inventory will not. Therefore, if embedded in a {@link Gui}, it is necessary to call
 * {@link me.mykindos.betterpvp.core.inventory.inventory.Inventory#notifyWindows()} manually in order for changes to be displayed.
 */
public class ReferencingInventory extends me.mykindos.betterpvp.core.inventory.inventory.Inventory {
