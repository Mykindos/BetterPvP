-- Class armours
INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
...
INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "GOLDEN_AXE" AND Module = "Champions"), 0, "<gray>Damage: <green>5");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("GOLDEN_SWORD", "Champions", "<yellow>Radiant Sword", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "GOLDEN_SWORD" AND Module = "Champions"), 0, "<gray>Damage: <green>6");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("IRON_SWORD", "Champions", "<yellow>Standard Sword", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "IRON_SWORD" AND Module = "Champions"), 0, "<gray>Damage: <green>4.5");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("IRON_AXE", "Champions", "<yellow>Standard Axe", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "IRON_AXE" AND Module = "Champions"), 0, "<gray>Damage: <green>3");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("DIAMOND_SWORD", "Champions", "<yellow>Power Sword", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "DIAMOND_SWORD" AND Module = "Champions"), 0, "<gray>Damage: <green>5");

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "DIAMOND_SWORD" AND Module = "Champions"), 1, "<gray>+1 Level to Sword Skills");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("DIAMOND_AXE", "Champions", "<yellow>Power Axe", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "DIAMOND_AXE" AND Module = "Champions"), 0, "<gray>Damage: <green>4");

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "DIAMOND_AXE" AND Module = "Champions"), 1, "<gray>+1 Level to Axe Skills");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("NETHERITE_SWORD", "Champions", "<yellow>Ancient Sword", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "NETHERITE_SWORD" AND Module = "Champions"), 0, "<gray>Damage: <green>6");

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "NETHERITE_SWORD" AND Module = "Champions"), 1, "<gray>+1 Level to Sword Skills");

INSERT IGNORE INTO ${coreTablePrefix}items (Material, Module, Name, Glow) VALUES
    ("NETHERITE_AXE", "Champions", "<yellow>Ancient Axe", 0);

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "NETHERITE_AXE" AND Module = "Champions"), 0, "<gray>Damage: <green>5");

INSERT IGNORE INTO ${coreTablePrefix}itemlore
    VALUES ((SELECT id FROM ${coreTablePrefix}items WHERE Material = "NETHERITE_AXE" AND Module = "Champions"), 1, "<gray>+1 Level to Axe Skills");
