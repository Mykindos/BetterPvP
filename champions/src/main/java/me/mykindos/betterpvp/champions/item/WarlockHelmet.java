...
@Singleton
@ItemKey("champions:warlock_helmet")
...
public class WarlockHelmet extends ArmorItem {
    ...
    private WarlockHelmet(Champions champions) {
        super(champions, translatableName("champions.item.warlock-helmet.name"), ItemStack.of(Material.NETHERITE_HELMET), ItemRarity.COMMON);
