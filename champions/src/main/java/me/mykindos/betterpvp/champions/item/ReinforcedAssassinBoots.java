...
public class ReinforcedAssassinBoots extends ArmorItem {
    ...
    private void registerRecipe(CraftingRecipeRegistry registry, ItemFactory itemFactory, LeatherFabric block) {
        ...
        registry.registerRecipe(new NamespacedKey("champions", "reinforced_assassin_boots_top"), builder1.build());
        ...
        registry.registerRecipe(new NamespacedKey("champions", "reinforced_assassin_boots_bottom"), builder2.build());
    }
}
