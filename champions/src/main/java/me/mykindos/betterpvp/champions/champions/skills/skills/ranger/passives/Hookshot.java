...
public class Hookshot extends ChannelSkill implements Listener, PassiveSkill, DamageSkill, OffensiveSkill {
    ...
    public String[] getDescription(int level) {
        ...
        return new String[]{
                ...
                "and release to shoot an arrow with a hook that pulls",
    ...
    public void onDamage(CustomDamageEvent event) {
        ...
        if (bonus.containsKey(arrow)) {
            ...
            VelocityData velocityData = new VelocityData(vec, velocityStrength, false, 0.0D, 0.2 * bonus.get(arrow), 0.6 * bonus.get(arrow), true);
    ...
    public void loadSkillConfig() {
        ...
        pullMultiplier = getConfig("pullMultiplier", 1.0, Double.class);
