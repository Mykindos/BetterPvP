...
import me.mykindos.betterpvp.core.inventory.gui.GuiParent;
import me.mykindos.betterpvp.core.inventory.gui.SlotElement;
import me.mykindos.betterpvp.core.inventory.inventory.CompositeInventory;
...
public abstract class AbstractWindow implements Window, GuiParent {
    ...
    public void open() {
        ...
        try {
            ...
            if(!Bukkit.isPrimaryThread()) {
                ...
                log.error("Attempted to open window from non-primary thread for player {}", viewer.getName()).submit();
                return;
            }
    ...
    /**
     * Gets the content {@link me.mykindos.betterpvp.core.inventory.inventory.Inventory inventories} associated with this
     ...
     */
    protected abstract List<me.mykindos.betterpvp.core.inventory.inventory.Inventory> getContentInventories();
