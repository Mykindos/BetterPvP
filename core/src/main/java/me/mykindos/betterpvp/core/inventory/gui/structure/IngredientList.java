...
public class IngredientList extends ArrayList<me.mykindos.betterpvp.core.inventory.gui.structure.Ingredient> {
     ...
     * @param ingredientMap The {@link HashMap} containing the {@link me.mykindos.betterpvp.core.inventory.gui.structure.Ingredient Ingredients}.
     */
    public IngredientList(int width, int height, String structure, HashMap<Character, me.mykindos.betterpvp.core.inventory.gui.structure.Ingredient> ingredientMap) {
        this.width = width;
        this.height = height;
        
        for (char c : structure.toCharArray()) {
            me.mykindos.betterpvp.core.inventory.gui.structure.Ingredient ingredient = null;
    ...
    /**
     * Inserts the {@link me.mykindos.betterpvp.core.inventory.gui.structure.Ingredient Ingredients} into the specified {@link Gui}.
     *
    ...
    public void insertIntoGui(Gui gui) {
        ...
        for (int i = 0; i < size(); i++) {
            me.mykindos.betterpvp.core.inventory.gui.structure.Ingredient ingredient = get(i);
    ...
    /**
     * Finds all indices of the {@link me.mykindos.betterpvp.core.inventory.gui.structure.Markers#CONTENT_LIST_SLOT_HORIZONTAL} and {@link me.mykindos.betterpvp.core.inventory.gui.structure.Markers#CONTENT_LIST_SLOT_VERTICAL} {@link Marker Markers}.
     *
     * @return The indices.
     */
    public int[] findContentListSlots() {
        return Stream.concat(
            findIndicesOfHorizontalMarker(me.mykindos.betterpvp.core.inventory.gui.structure.Markers.CONTENT_LIST_SLOT_HORIZONTAL).stream(),
