...
public class PreviousRecipeButton extends ControlItem<BPvPRecipeMenu> {
    /**
    ...
    public ItemProvider getItemProvider(BPvPRecipeMenu gui) {
        final ItemView.ItemViewBuilder builder = ItemView.builder().material(Material.RED_STAINED_GLASS_PANE);
            builder.displayName(UtilMessage.deserialize("<red>Previous Page"));
