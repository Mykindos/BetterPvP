...
public class PortableKnightSelector extends PortableClassSelectorItem {
    ...
    private void registerRecipe(CraftingRecipeRegistry registry, ItemFactory itemFactory, Rope rope) {
        ...
        registered = true;
        final BaseItem ore = itemFactory.getFallbackItem(Material.IRON_INGOT);
        ...
        registry.registerRecipe(new NamespacedKey("champions", "portable_knight_selector"), builder.build());
    }
}
