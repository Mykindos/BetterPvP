...
SELECT L1.id as ID, L1.Time, L1.type, C1.MainPlayerID, C2.MainClan, CN1.Name as MainClanName, C3.OtherPlayerID, C4.OtherClan, CN2.Name as OtherClanName FROM logmeta L1
...
BEGIN
    SELECT DISTINCT CL.Time, CL.type, CLIENTS1.Name as MainPlayerName, CL.MainClan, CL.MainClanName, CLIENTS2.Name as OtherPlayerName, CL.OtherClan, CL.OtherClanName
    FROM clanlogs CL
    LEFT JOIN betterpvp_global.clients as CLIENTS1 ON CLIENTS1.UUID = CL.MainPlayerID
    LEFT JOIN betterpvp_global.clients as CLIENTS2 ON CLIENTS2.UUID = CL.OtherPlayerID
