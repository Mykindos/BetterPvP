...
public class ChargeData {
     ...
     */
    public static DisplayObject<Component> getActionBar(Predicate<Gamer> showCondition, Function<Gamer, ? extends ChargeData> supplier) {
     ...
     */
    public static DisplayObject<Component> getActionBar(IChampionsSkill skill, Map<Player, ? extends ChargeData> chargeDataMap) {
        return getActionBar(
     ...
     * @see ChargeData#getActionBar(Predicate, Function)
     */
    public static DisplayObject<Component> getActionBar(IChampionsSkill skill, Map<Player, ? extends ChargeData> chargeDataMap, Predicate<Gamer> additionalShowCondition) {
        return getActionBar(
