...
/**
 * Satisfies the {@link me.mykindos.betterpvp.core.scene.prop.Prop Prop}↔{@link PropFactory} pairing for
 * {@link GatewayProp}.
 * <p>
 ...
 * therefore intentionally not registered with the {@code PropFactoryManager} and rejects command spawns.
 */
@Singleton
public class GatewayPropFactory extends PropFactory {
