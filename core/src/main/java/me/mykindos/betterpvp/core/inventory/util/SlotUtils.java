...
public class SlotUtils {
    ...
    public static int convertToIndex(@NotNull me.mykindos.betterpvp.core.inventory.util.Point2D point, int width) {
    ...
    @NotNull
    public static me.mykindos.betterpvp.core.inventory.util.Point2D convertFromIndex(int index, int width) {
        return new me.mykindos.betterpvp.core.inventory.util.Point2D(index % width, index / width);
    }
    ...
    public static int getLongestLineLength(int[] slots, int frameWidth) {
        int longestLength = 0;
        int currentLength = 1;
        me.mykindos.betterpvp.core.inventory.util.Point2D previous = null;

        for (me.mykindos.betterpvp.core.inventory.util.Point2D point : Arrays.stream(slots)
                .mapToObj(index -> convertFromIndex(index, frameWidth)).toList()) {
            if (previous != null) {
    ...
    public static boolean isNeighbor(@NotNull me.mykindos.betterpvp.core.inventory.util.Point2D point1, @NotNull Point2D point2) {
