...
public abstract class PowerBase extends SingleStatRune {

    protected PowerBase(Champions plugin, String key) {
        super(plugin, key);
    }
    ...
    public List<Component> getRuneLoreDescription(ItemMeta itemMeta) {
        ...
        return List.of(UtilMessage.deserialize("<gray>Increases arrow damage by <green>%.1f", roll));
    }
    ...
    public NamespacedKey getAppliedNamespacedKey() {
        return RuneNamespacedKeys.POWER;
    }
