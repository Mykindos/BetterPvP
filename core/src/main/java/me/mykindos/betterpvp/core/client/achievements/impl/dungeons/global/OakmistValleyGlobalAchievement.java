...
@CustomLog
@Singleton
public class OakmistValleyGlobalAchievement extends SingleSimpleAchievement {

    @Inject
    public OakmistValleyGlobalAchievement() {
        super("Beat the Oakmist Valley",
                new NamespacedKey("dungeons", "oakmist_valley_global_1"),
    ...
    public List<String> getStringDescription(StatContainer container, StatFilterType type, Period period) {
        return List.of("Defeat the boss of the Oakmist Valley");
    }
}
