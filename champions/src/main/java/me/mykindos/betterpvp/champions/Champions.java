...
public class Champions extends BPvPPlugin {
    ...
    public void onEnable() {
        ...
        if (core != null) {
            ...
            database.getConnection().runDatabaseMigrations(getClass().getClassLoader(), "classpath:champions-migrations/local", "local", TargetDatabase.LOCAL);
            database.getConnection().runDatabaseMigrations(getClass().getClassLoader(), "classpath:champions-migrations/global", "global", TargetDatabase.GLOBAL);
