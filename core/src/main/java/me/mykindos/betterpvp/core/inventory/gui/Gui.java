...
import me.mykindos.betterpvp.core.inventory.animation.Animation;
...
/**
 * A Gui is a container for width * height {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements}.<br>
 * Each {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} can either be an {@link Item},
 * a reference to a {@link Inventory}'s or another {@link Gui}'s
 * slot index.<br>
 * A {@link Gui} is not an {@link org.bukkit.inventory.Inventory}, nor does
 * it access one. It just contains {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} and their positions.<br>
 * In order to create an {@link org.bukkit.inventory.Inventory} which is visible
 * to players, you will need to use a {@link Window}.
 *
 * @see me.mykindos.betterpvp.core.inventory.gui.PagedGui
 * @see ScrollGui
 * @see TabGui
 */
public interface Gui {
    ...
    /**
     * Sets the {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} on these coordinates.
     * If you need to set an {@link Item}, please use {@link #setItem(int, int, Item)} instead.
     *
     * @param x           The x coordinate
     * @param y           The y coordinate
     * @param slotElement The {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} to be placed there.
     */
    ...
    /**
     * Adds {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} to the {@link Gui}.
     *
     * @param slotElements The {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} to add.
     */
    void addSlotElements(@NotNull me.mykindos.betterpvp.core.inventory.gui.SlotElement... slotElements);
    
    /**
     * Gets the {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} on these coordinates.
     *
     * @param x The x coordinate
     * @param y The y coordinate
     * @return The {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} placed there
     */
    @Nullable
    me.mykindos.betterpvp.core.inventory.gui.SlotElement getSlotElement(int x, int y);
    
    /**
     * Gets the {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} placed on that slot.
     *
     * @param index The slot index
     * @return The {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} placed on that slot
     */
    @Nullable
    me.mykindos.betterpvp.core.inventory.gui.SlotElement getSlotElement(int index);
    
    /**
     * Gets if there is a {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} on these coordinates.
     *
     * @param x The x coordinate
     * @param y The y coordinate
     * @return If there is a {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} placed there
     */
    boolean hasSlotElement(int x, int y);
    
    /**
     * Gets if there is a {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} placed on that slot.
     *
     * @param index The slot index
     * @return If there is a {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} placed there
     */
    ...
    /**
     * Gets all {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} of this {@link Gui} in an Array.
     *
     * @return All {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} of this {@link Gui}
     */
     ...
     * @param replaceExisting If existing {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} should be replaced.
     */
    ...
    interface Builder<G extends Gui, S extends Builder<G, S>> extends Cloneable {
        ...
        /**
         * Adds a {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement} ingredient under the given key.
         *
         * @param key     The key
         * @param element The {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement}
         * @return This {@link Builder Gui Builder}
         */
        @Contract("_, _ -> this")
        @NotNull S addIngredient(char key, @NotNull me.mykindos.betterpvp.core.inventory.gui.SlotElement element);
        ...
        /**
         * Adds a {@link Supplier} of {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements} ingredient under the given key.
         *
         * @param key             The key
         * @param elementSupplier The {@link Supplier} of {@link me.mykindos.betterpvp.core.inventory.gui.SlotElement SlotElements}
         * @return This {@link Builder Gui Builder}
         */
        @Contract("_, _ -> this")
